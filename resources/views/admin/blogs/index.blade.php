...
@section('title', 'ADMIN BERKAH SAFTINDO | Daftar Blog/News')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <h5 class="card-title">Daftar Blog / News</h5>
                            <a href="{{ route('blogs.create') }}" class="btn btn-primary btn-margin-top">
